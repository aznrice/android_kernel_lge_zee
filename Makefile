...
AFLAGS_MODULE   =
LDFLAGS_MODULE  =
CFLAGS_KERNEL	= -mtune=cortex-a57 -march=armv8-a+crc -mfpu=neon-vfpv4 -ftree-vectorize
AFLAGS_KERNEL	= -mtune=cortex-a57 -march=armv8-a+crc -mfpu=neon-vfpv4 -ftree-vectorize
