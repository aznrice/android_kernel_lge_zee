...
AFLAGS_MODULE   =
LDFLAGS_MODULE  =
CFLAGS_KERNEL	= -mtune=generic-armv7-a -march=armv7-a -mfpu=neon-vfpv4 -ftree-vectorize
AFLAGS_KERNEL	= -mtune=generic-armv7-a -march=armv7-a -mfpu=neon-vfpv4 -ftree-vectorize
