...
#if defined(CONFIG_MACH_LGE) && !defined(CONFIG_MACH_MSM8974_VU3_KR) && !defined(CONFIG_MACH_MSM8974_Z_KR) && !defined(CONFIG_MACH_MSM8974_Z_US) && !defined(CONFIG_MACH_MSM8974_Z_OPEN_COM) && !defined(CONFIG_OLED_SUPPORT)
...
#if defined(CONFIG_MACH_LGE) && !defined(CONFIG_MACH_MSM8974_Z_KR) && !defined(CONFIG_MACH_MSM8974_Z_US) && !defined(CONFIG_MACH_MSM8974_Z_OPEN_COM) && !defined(CONFIG_OLED_SUPPORT)
