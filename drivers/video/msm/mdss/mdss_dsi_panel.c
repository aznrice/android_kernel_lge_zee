...
static void mdss_dsi_panel_blackout_dcs(struct mdss_dsi_ctrl_pdata * ctrl)
{
	struct dcs_cmd_req cmdreq;
							...
							u32 bl_level)
{
	...
	case BL_DCS_CMD:
		...
		if (bl_level == 0x00) mdss_dsi_panel_blackout_dcs(ctrl_pdata);
		break;
	default:
...
#if defined(CONFIG_MACH_LGE) && !(defined(CONFIG_MACH_MSM8974_Z_KR) || defined(CONFIG_MACH_MSM8974_Z_US) || defined(CONFIG_MACH_MSM8974_Z_KDDI) || defined(CONFIG_MACH_MSM8974_Z_OPEN_COM))
