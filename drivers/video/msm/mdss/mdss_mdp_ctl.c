...
/* LGE_CHANGE
 * This is for slimport underrun(on phone-side when unplugging cable) patch
 * from case #01249713, #01289775
 * 2013-09-13, minkyeong.kim@lge.com
 */
		...
		struct mdss_mdp_perf_params *perf)
{
	 ...
	 * To avoid under-run issue and optimize current consumption in Z_HD
