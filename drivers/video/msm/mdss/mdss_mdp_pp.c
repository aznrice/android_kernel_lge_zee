...
struct mdp_csc_cfg dmb_csc_convert = {
	...
	{ 0x0, 0xff, 0x0, 0xff, 0x0, 0xff,},
	{ 0x0, 0xff, 0x0, 0xff, 0x0, 0xff,},
#elif defined(CONFIG_MACH_MSM8974_Z_KR) || defined(CONFIG_MACH_MSM8974_Z_US) || defined(CONFIG_MACH_MSM8974_Z_KDDI) || defined(CONFIG_MACH_MSM8974_Z_OPEN_COM)
	0,
	{
...
#if defined(CONFIG_LGE_BROADCAST_ONESEG) || defined(CONFIG_LGE_BROADCAST_FULLSEG)
struct mdp_csc_cfg dmb_csc_convert = {
...
static int pp_vig_pipe_setup(struct mdss_mdp_pipe *pipe, u32 *op)
{
	...
	if ((pipe->flags & MDP_OVERLAY_PP_CFG_EN) &&
		 ...
		 */
		if (pipe->play_cnt == 0) {
#if !defined(CONFIG_LGE_BROADCAST_TDMB) && !defined(CONFIG_LGE_BROADCAST_ONESEG) && !defined(CONFIG_LGE_BROADCAST_FULLSEG)
