...
#if defined(CONFIG_LGE_BROADCAST_TDMB) || defined(CONFIG_LGE_BROADCAST_ONESEG) || defined (LGE_BROADCAST_ONESEG) || defined(CONFIG_LGE_BROADCAST_FULLSEG) || defined (LGE_BROADCAST_FULLSEG)
