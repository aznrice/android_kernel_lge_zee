...
//LGE_CHANGE_S, D2-Z-BSP-Kernel-Memory@lge.com, for tuxera exfat moudule operation.
EXPORT_SYMBOL(is_cma_pageblock);
//LGE_CHANGE_E, D2-Z-BSP-Kernel-Memory@lge.com, for tuxera exfat moudule operation.
