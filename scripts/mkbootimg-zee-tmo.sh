...
echo $KERNEL_PATH
$KERNEL_PATH/scripts/mkbootimg  --kernel $KERNEL_PATH/arch/arm/boot/zImage-dtb --ramdisk $KERNEL_PATH/arch/arm/boot/ramdisktmo.img \
	...
	--output $KERNEL_PATH/arch/arm/boot/boot.img
