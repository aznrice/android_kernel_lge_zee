...
$KERNEL_PATH/scripts/lg_dt_viewer/lg_dtc -p 1024 -O dtb -o $KERNEL_PATH/arch/arm/boot/msm8974-v2-z-tmo.dtb $KERNEL_PATH/arch/arm/boot/dts/msm8974-z-tmo/msm8974-v2-z-tmo.dts
$KERNEL_PATH/scripts/lg_dt_viewer/lg_dtc -p 1024 -O dtb -o $KERNEL_PATH/arch/arm/boot/msm8974-z-tmo.dtb $KERNEL_PATH/arch/arm/boot/dts/msm8974-z-tmo/msm8974-z-tmo.dts
